    ...
    <div className="tactical-glass rounded-lg border border-white/10 p-3 flex flex-col space-y-2.5 h-full shadow-xl tactical-corner overflow-hidden">
      ...
      <div className="flex items-center justify-between border-b border-white/10 pb-2 shrink-0">
        ...
        <span className="text-[10px] font-mono text-slate-400">
          Total: <strong className="text-amber-300 font-bold">{incidents.length}</strong>
        </span>
      </div>
        ...
        {incidents.map((incident) => {
          ...
          return (
            ...
            >
              ...
              {/* Confidence and Multi-modal Evidence Grid */}
              <div className="grid grid-cols-4 gap-1.5 mb-2 font-mono text-xs">
                {/* Confidence */}
                <div className="bg-[#07090f] p-1.5 rounded border border-white/5 flex flex-col justify-center">
                  <div className="text-[9px] text-slate-400 font-semibold">SURVIVOR CONF</div>
                  <div className="font-tech text-base font-extrabold text-rose-400 leading-tight">
                    {Math.round(incident.confidence * 100)}%
                  </div>
                </div>

                {/* Visual */}
                <div className="bg-[#07090f] p-1.5 rounded border border-white/5 flex items-center space-x-1.5">
                  <Eye className="w-3 h-3 text-amber-400 shrink-0" />
                  <div>
                    <div className="text-[8px] text-slate-500">RGB</div>
                ...
                <div className="bg-[#07090f] p-1.5 rounded border border-white/5 flex items-center space-x-1.5">
                  ...
                  <div>
                    <div className="text-[8px] text-slate-500">AUDIO</div>
